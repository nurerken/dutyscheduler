...
public class ActiveDirectory {
     ...
     */
    public static LdapContext getConnection(String username, String password, String ldapURL) throws NamingException {
        ...
        try{
            ...
            throw new NamingException("Failed to authenticate " + username +  " through " + ldapURL);
        }
    }
     ...
     * @return
     */
    public static String getUserInfo(String username, LdapContext ctx) {
        String userInfo = "";
        try {
            SearchControls constraints = new SearchControls();
            constraints.setSearchScope(SearchControls.SUBTREE_SCOPE);
            String[] attrIDs = {"givenName", "sn", "title", "mobile", "department", "physicalDeliveryOfficeName"};
            constraints.setReturningAttributes(attrIDs);

            NamingEnumeration answer = ctx.search("DC=kar-tel,DC=local", "sAMAccountName=" + username, constraints);

            if (answer.hasMore()) {
                Attributes attrs = ((SearchResult) answer.next()).getAttributes();
                userInfo = attrs.get("givenName").toString() + "|" + attrs.get("sn") + "|" + attrs.get("title") + "|" + attrs.get("mobile")  + "|" + attrs.get("department")  + "|" + attrs.get("physicalDeliveryOfficeName");
            }else{
